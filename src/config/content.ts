export const SITE_CONFIG = {
  ...
  description: 'Kenya\'s trusted Bulk SMS provider. Enterprise SMS solutions for businesses, banks, schools, hospitals & NGOs. Branded Sender IDs, OTP verification, USSD & API integration.',
} as const;
